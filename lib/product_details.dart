...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    String? imgURI = args?.imgcropped.replaceAll(RegExp('https://storage.googleapis.com/application-monitoring/'), ''); //Remove header
    return Scaffold(
        appBar: AppBar(
...
class ProductArguments {
  ...
  ProductArguments(this.id, this.title, this.description,
      this.imgcropped, this.price,
